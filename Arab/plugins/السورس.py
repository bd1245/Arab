...
async def source(e):
    await edit_or_reply(e, "https://github.com/bd1245/telethon/tree/patch-2",)
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون ويلسون - Telethon-WELSON ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"🝳︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس ويلسون @kyany_el5as :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """🝳︙ جـاري تـحديث تليثـون ويلسون (7.7)
...
قناة الكلايش  : @kyany_el5as
قناه شروحات الاوامر  : @kyany_el5as
قناه المتغيرات او الفارات : @kyany_el5as""")
    ...
    if exe == "get":
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(                    "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬  - 𝑾𝑬𝑳𝑺𝑶𝑵 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"                    f"\n **⌔** `{variable} = {heroku_var[variable]}` .\n"                )
            return await ics.edit(                "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 - 𝑾𝑬𝑳𝑺𝑶𝑵 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"                f"\n **⌔ خطا :**\n-> {variable} غيـر موجود. "            )
        except IndexError:
...
🝳  اوامر الملصقات ↢ ( .م16 )
———————×———————
شرح الأوامر : ( @kyany_el5as ) .
قناه السورس : ( @kyany_el5as ) .
...
( .ايقاف اسم وقتي )
———————×———————
 🝳︙ يوجد شرح مفصل عن الامر هنا : https://t.me/kyany_el5as
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/kyany_el5as
شرح الأوامر : ( @kyany_el5as ) .
قناه السورس : ( @kyany_el5as ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/kyany_el5as 
قناه السورس : ( @kyany_el5as ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/kyany_el5as
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/kyany_el5as  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/kyany_el5as  ⦒
""")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**🝳︙ قـائمـه الاوامـر :**\n**🝳︙ قنـاه السـورس :** @kyany_el5as\n**🝳︙ شـرح اوامـر السـورس : @kyany_el5as**\n**🝳︙ شـرح فـارات السـورس : @kyany_el5as** "
